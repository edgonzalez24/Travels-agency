...
--
-- Host: 127.0.0.1    Database: agency-travels
-- ------------------------------------------------------
...
INSERT INTO `testimoniales` VALUES (1,'Edwin','edwin.gonzalez@elaniin.com','Estoy usando Sequelize en NodeJS');
...
CREATE TABLE `viajes` (
  ...
  `disponibles` varchar(3) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-03-13  5:14:03
